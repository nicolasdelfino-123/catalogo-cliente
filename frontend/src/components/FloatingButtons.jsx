...
export default function FloatingButtons() {
  ...
  "
            ...
            {/* WhatsApp flotante SOLO en móviles */}
            {/*   <a
                href={WA_URL}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="md:hidden fixed bottom-10 right-3 z-[9999] w-12 h-12 rounded-full bg-green-500 flex items-center justify-center shadow-lg hover:bg-green-600 transition"
            >
                <svg
